  ...
  if (forecastCronJobActive) {
    ...
    setInterval(async () => {
      ...
      if (Object.keys(trainingJSON).length < 16) {
        ...
        const fetchPredictedPrice = await fetch(
  ...
  return (
    <Container>
                        ...
                        <TableBody>
                          {txnHistory.map((txn, i) => (
                            <TableRow key={i}>
                              ...
                              <TableCell style={{ fontSize: '14px' }}>
                                {powerToInteger(
                                  txn.events && txn.events[0] && txn.events[0].data && txn.events[0].data.amount ? txn.events[0].data.amount * Math.pow(10, -8) : 0,
                                )}
                              </TableCell>
                              <TableCell style={{ fontSize: '14px' }}>
      ...
      <Notice>
        <p
          style={{
            ...
            fontSize: '20px',
            fontWeight: 530,
            color: `${({ theme }: { theme: any }) => theme.colors.error?.muted}`,
            padding: '0px 10px',
          }}
        >
      ...
      <Notice>
        ...
        >
          Predicted price for next minute{' '}
        </p>
        <Typography
          variant="h4"
          style={{ textAlign: 'center', marginTop: '10px' }}
